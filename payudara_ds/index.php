...
<head>
    ...
    <title>SisPak Kanker Payudara|DmShafer</title>
...
<div id="art-main">
    ...
    <div class="art-header-inner">
        ...
        <div class="art-logo">
                 <h1 class="art-logo-name"><a href="./index.html">Sistem Pakar Deteksi Dini Penyakit Kanker Payudara</a></h1>
                  <h2 class="art-logo-text">Menggunakan Metode Dempster Shafer</h2>
        </div>
    </div>
    </div>
    </div>
