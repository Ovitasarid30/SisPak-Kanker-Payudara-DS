...
function validasi(form){
	if(form.kdgejala.value==""){
		...
		form.kdgejala.focus(); return false;
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0">
  ...
  <tr>
    ...
    <td><a title="Edit Penyakit" href="edgejala.php?kdubah=<?php echo $data['kdgejala'];?>"><img src="image/edit.jpeg" width="16" height="16" border="0"></a></td>
    <td><a title="Hapus Gejala" style="cursor:pointer;" onclick="return konfirmasi('<?php echo $data['kdgejala'];?>');"><img src="image/hapus.jpeg" width="16" height="16" ></a></td>
  </tr>
  <?php
  } ?>
</table></div>
